  ...
  return (
    <div className="bg-gray-500">
      <div className={styles.container}>
        <Head>
          <title>The Coonies NFT</title>
          <meta name="5k Special Generative NFT Art collection of the coolest, cooniest $COONS on the Aptos Blockchain" content="The Coonies NFT Mint" />
          ...
          <link href="https://www.dafontfree.net/embed/cGFzc2lvbi1vbmUtYm9sZCZkYXRhLzEwL3AvNTkyNTgvUGFzc2lvbk9uZS1Cb2xkLnR0Zg" rel="stylesheet" type="text/css"/>
        </Head>
        <img
        ...
        <main className={styles.main}>
          <h1 className={styles.title}>
            {/* {collectionName} */}
            <img src="https://thecoonies.com/wp-content/uploads/2022/12/coonies-logo-e1670631835716.png" className={styles.mintlogo} />
          </h1>
          ...
          <div id="collection-info" className="d-flex flex-column align-items-center text-white" style={{width: "80%"}}>
            ...
            <>
              <div className="d-flex align-items-center my-3">
                ...
                <button onClick={incrementMintAmount} className={styles.inputbtns} style={{border: incActive ? '' : '1px solid #EC1D78'}}>▲</button>
                <button onClick={decrementMintAmount} className={styles.inputbtns} style={{border: decActive ? '' : '1px solid #EC1D78' }}>▼</button>
                </div>
